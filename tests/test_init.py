...
def test_new_df_series_methods_become_it_only_after_pandas_tools_is_imported(df_to_merge):
    # Given
...
def test_safe_replace_as_a_method_of_a_dataframe(df_to_merge):
    # Given
    patch_pandas()
...
def test_safe_merge_as_a_method_of_a_dataframe(df_to_merge):
    # Given
    patch_pandas()
...
def test_assert_values_as_a_method_of_a_series(df_to_merge):
    # Given
    patch_pandas()
...
def test_assert_type_as_a_method_of_a_series(df_to_merge):
    # Given
    patch_pandas()
